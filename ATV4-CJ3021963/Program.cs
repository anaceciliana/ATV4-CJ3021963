...

{
    ...
    case 2: Console.WriteLine(" O pagamento será efetuado no crédito");
        Console.WriteLine("Haverá um acréssimo de 3%");
        break;

    case 3: Console.WriteLine("O pagamento será efetuado por pix");
        Console.WriteLine("Haverá um desconto de 5%");
        break;

    case 4: Console.WriteLine("O pagamento será efetuado em boleto");
        Console.WriteLine(" Haverá um acréssimo de 5% ");
        break;

    case 5: Console.WriteLine(" Será realizado uma transferência bancária");
        break;
